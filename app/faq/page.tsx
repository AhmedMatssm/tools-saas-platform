    ...
    <div className="max-w-7xl mx-auto px-6 py-20 space-y-24">
       ...
       <div className="grid lg:grid-cols-5 gap-16">
          ...
          <aside className="lg:col-span-1 space-y-4 h-fit">
             ...
             {loading ? <div className="ml-2 mt-4 opacity-50"><Loader2 className="w-4 h-4 animate-spin" /></div> : dynamicCategories.map(cat => {
          ...
          <main className="lg:col-span-4 space-y-4">
             {loading ? (
                <div className="py-20 flex justify-center w-full text-muted-foreground"><Loader2 className="w-8 h-8 animate-spin" /></div>
