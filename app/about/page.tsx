      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-32">
         ...
         <section className="text-center space-y-8 max-w-4xl mx-auto">
            <motion.div
               ...
               className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 py-1 px-4 rounded-full text-xs font-black uppercase tracking-widest text-primary"
            >
            ...
            >
               ...
               Astryxo was founded in 2024 to provide professional-grade AI tools with
               unmatched UX and enterprise-ready speed.
            </motion.p>
         </section>
         ...
         <section className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 order-2 lg:order-1">
               <h2 className="text-4xl font-bold">A Vision of <span className="text-primary">Unbounded Potential.</span></h2>
               <p className="text-muted-foreground tracking-wide leading-relaxed">
                  ...
                  Astryxo stands at the intersection of powerful neural networks and
               ...
               <div className="grid sm:grid-cols-2 gap-6 pt-4">
                  <div className="space-y-2 group">
                     <div className="w-10 h-10 bg-surface-hover rounded-lg flex items-center justify-center group-hover:bg-primary transition-colors">
                        <Zap className="w-5 h-5 text-primary group-hover:text-white" />
                     </div>
                     <h4 className="font-bold">Real-time Automation</h4>
                     <p className="text-xs text-muted-foreground">The world's fastest inference engine at your fingertips.</p>
                  </div>
                  <div className="space-y-2 group">
                     <div className="w-10 h-10 bg-surface-hover rounded-lg flex items-center justify-center group-hover:bg-primary transition-colors">
                        <Rocket className="w-5 h-5 text-primary group-hover:text-white" />
                     </div>
            ...
            <div className="relative order-1 lg:order-2 group">
               <div className="absolute inset-x-0 bottom-0 top-0 bg-primary/10 blur-[100px] rounded-full group-hover:bg-primary/20 transition-all duration-1000" />
               <Card variant="glass" className="aspect-square flex items-center justify-center relative shadow-2xl overflow-hidden border-2 border-white/5">
                  <div className="w-40 h-40 bg-gradient-premium rounded-3xl flex items-center justify-center animate-bounce shadow-2xl shadow-primary/40">
                     <Sparkles className="text-white w-20 h-20" />
                  </div>
                  {/* Decoration blobs */}
                  <div className="absolute top-10 right-10 w-4 h-4 rounded-full bg-primary animate-pulse" />
                  <div className="absolute bottom-10 left-10 w-6 h-6 rounded-full bg-primary animate-pulse delay-150" />
               </Card>
            </div>
         </section>
         ...
         <section className="space-y-16">
            <div className="text-center space-y-4">
               <h2 className="text-4xl font-black">Our <span className="text-primary text-gradient">Core Values</span></h2>
         ...
         <section className="max-w-3xl mx-auto space-y-8 bg-surface-hover/20 p-12 md:p-16 rounded-3xl border border-white/5 shadow-2xl text-center">
            <h2 className="text-3xl font-black">The Story of <span className="text-primary">Astryxo</span></h2>
            <p className="text-muted-foreground leading-relaxed italic">
               "We started in a small room with a large vision: to take the complex neural
               models and place them inside a tool that feels like magic. Today, Astryxo is
               trusted by tens of thousands of businesses to automate millions of complex workflows every month."
            </p>
            <div className="flex items-center justify-center gap-4 pt-4">
               <div className="w-12 h-12 rounded-full bg-gradient-premium border-2 border-white/20 shadow-xl" />
               <div className="text-left">
                  <p className="text-sm font-bold text-white">ahmed mouatassim</p>
